...
{
    /// <summary>
    /// ScriptableObject describing a timed multiplayer event similar to Brawl Stars' event rotation.
    /// </summary>
    [CreateAssetMenu(fileName = "EventDefinition", menuName = "BrawlShooter/Event Definition", order = 0)]
