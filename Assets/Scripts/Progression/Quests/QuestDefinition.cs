...
namespace BrawlShooter.Progression.Quests
{
    /// <summary>
    /// Simple quest definition for Brawl Pass-like progression.
    /// </summary>
    [CreateAssetMenu(fileName = "QuestDefinition", menuName = "BrawlShooter/Quest Definition", order = 0)]
